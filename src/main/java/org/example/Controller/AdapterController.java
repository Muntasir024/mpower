...
public class AdapterController {
    ...
    public String createBundle(@RequestBody String adapterData1)
            throws JsonProcessingException, ParseException {
//        System.out.println(id);

        ObjectMapper objectMapper = new ObjectMapper();
        AdapterData adapterData = objectMapper.readValue(adapterData1, AdapterData.class);
        ...
        composition.setTitle(adapterData.getEventType());
        ...
        for(Obs obs : adapterData.getObs()) {
            ...
            // Observation Code
            if(obs.getFieldCode().equals("edd") | obs.getFieldCode().equals("pregnancy_symptoms") | obs.getFieldCode().equals("has_edema") | obs.getFieldCode().equals("has_other_complication")) {
                ...
                if(obs.getHumanReadableValues() != null) coding2.setDisplay(obs.getHumanReadableValues().get(0));
            ...
            else if (obs.getFieldCode().equals("weight") | obs.getFieldCode().equals("bmi") | obs.getFieldCode().equals("body_temperature") | obs.getFieldCode().equals("pulse_rate") | obs.getFieldCode().equals("blood_pressure_systolic") | obs.getFieldCode().equals("blood_pressure_diastolic") | obs.getFieldCode().equals("uterus_length") | obs.getFieldCode().equals("hemoglobin_test") | obs.getFieldCode().equals("albumin_test") | obs.getFieldCode().equals("albumin_test") ) {
                ...
                valueQuantity.setValue(Integer.parseInt(obs.getValues().get(0)));
                ...
                immunization.setNotGiven(Boolean.parseBoolean(obs.getValues().get(0)));
